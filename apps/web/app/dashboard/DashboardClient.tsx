...
export default function DashboardClient(){
 ...
 return <main className="dashboard-shell"><aside><div className="logo">GA</div><strong>GAINT Academy</strong><nav><a className="active">Dashboard</a><a href="/students">Students</a><a href="/academics">Academics</a><a href="/staff">Staff</a><a href="/attendance">Attendance</a><a href="/reports">Reports</a><a>Settings</a></nav></aside>

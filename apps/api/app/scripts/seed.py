...
PERMISSIONS=["platform.dashboard.view","users.user.view","users.user.create","students.student.view","students.student.create","staff.staff.view","staff.staff.create","timetable.slot.manage","attendance.session.create","attendance.record.mark","attendance.session.submit","learning.course.manage","learning.assignment.manage","assessment.manage","assessment.marks.manage","assessment.publish","finance.plan.view","finance.plan.manage","finance.invoice.create","finance.payment.record","communication.notice.manage","communication.notice.publish","reports.summary.view","integrations.view","integrations.manage","grievances.manage","assets.manage","academics.setup.admin","audit.event.view"]
def run():

...
STUDENT_PERMISSIONS=["platform.dashboard.view","students.student.view","timetable.slot.view","attendance.session.view","learning.course.view","learning.submission.create","communication.notice.view","finance.plan.view","reports.summary.view"]
